...
export const ACTION_ITEMS: Record<string, string[]> = {
  ...
  employee: ["import", "export", "add", "gaji", "gaji_add", "gaji_edit", "gaji_delete"],
...
export const ACTION_LABELS: Record<string, Record<string, string>> = {
  ...
  employee: {
    import: "Import karyawan",
    export: "Export karyawan",
    add: "Tambah karyawan",
    gaji: "Lihat menu gaji karyawan",
    gaji_add: "Tambah catatan gaji",
    gaji_edit: "Edit gaji & setelan",
    gaji_delete: "Hapus gaji",
  },
